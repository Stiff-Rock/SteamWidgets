...
import com.stiffrock.wakatimewidgets.ui.MainActivity.Companion.STEAM_ID_PREF
...
internal fun updateAppWidget(
    ...
    val savedApiKey = sharedPreferences.getString(STEAM_ID_PREF, "") ?: ""
...
private suspend fun getLangStats(apiKey: String): Array<Language> {
    ...
    return try {
        val response = SteamApi.service.getLangStats(apiKey)
        if (!response.isSuccessful) {
            Log.e(
                TAG,
